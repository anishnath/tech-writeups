	...
	<script type="application/ld+json">
{
  ...
  "name" : "openstack glance images upload,delete,list,protect image, create image with default disk space",
  ...
  "applicationCategory" : [ "openstack glance disk format","glance container formats" ,"glance upload image" ," glance delete image" , "glance set protected image", "glance create public shared image" ],
  "downloadUrl" : "https://8gwifi.org/docs/glance.jsp",
  "operatingSystem" : "Linux,Unix,Windows,Redhat,RHEL,Fedora,Ubuntu",
  "requirements" : "openstack glance images upload,delete,list,protect image, create image with default disk space",
